...
function client() {
	...
	header['user-agent'] = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36";
	...
	this.setTaskNote = function(taskId, note) {
		var params = {
			k: 'PUT',
			url: "https://www.teambition.com/api/tasks/" + taskId
		};
		var r = http.request('PUT', params.url, JSON.stringify(note), header);
		return r.body.readAll().toString();
	}
}
